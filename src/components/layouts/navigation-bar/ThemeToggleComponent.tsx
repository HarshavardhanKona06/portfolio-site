        ...
        >
            ...
            >
                <FontAwesomeIcon icon={faSun}
                                 className="h-7 w-7 absolute text-amber-700 dark:text-amber-500 transition-all duration-300 rotate-90 scale-0 dark:scale-100 dark:rotate-0"
                                 strokeWidth={2.5}
                />

                <FontAwesomeIcon icon={faMoon}
                    className="h-7 w-7 absolute text-violet-500 dark:text-violet-300 transition-all duration-300 rotate-0 scale-100 dark:scale-0 dark:-rotate-90"
                    strokeWidth={2.5}
                />
            </animated.div>
